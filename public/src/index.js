...
class AppContainer extends HTMLElement {
    ...
    render(){
        ...
        <nav-menu selected="#ffffff17" icon="https://media.discordapp.net/attachments/1010976865424506900/1083289685327089695/Frame_1.png?width=30&height=30"></nav-menu>
        <nav-menu></nav-menu>
        <nav-menu></nav-menu>
        <nav-menu></nav-menu>
        </section>
