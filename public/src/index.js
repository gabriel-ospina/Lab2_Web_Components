...
class AppContainer extends HTMLElement {
    ...
    render(){
        ...
        <nav-menu  icon="https://media.discordapp.net/attachments/1010976865424506900/1083289684467261440/Frame_4.png?width=30&height=30" page="Ver más tarde"></nav-menu>
